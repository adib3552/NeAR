...
def main():
    ...
    parser.add_argument('--topK', type=int, default=3, help='top K periods')
    ...
    parser.add_argument('--sample_k', type=int, default=10, help='Top K for stochastic pool')
    parser.add_argument('--d_model', type=int, default=512, help='dimension of model')
    parser.add_argument('--n_vars', type=int, default=512, help='number of variates')
...
if __name__ == "__main__":
    ...
    mp.set_start_method("spawn", True)  # explicit safety
    main()